...
public class PopupUI : NetworkUI
{
    ...
    {       
        ...
        {
            textLabel.text = data.player1.id == LocalClientId ? "Player 2 Won!" : "you Won!";          
        }
        else if (data.player2.cardsCount == 0)
        {
            textLabel.text = data.player2.id == LocalClientId ? "Player 2 Won!" : "you Won!";           
        }
        else
        {
            textLabel.text =  "Player 2 left the game, you Won!";
        }
